<template>
  <div class="assigned-view pa-4">
    <div class="text-h6 font-weight-bold mb-1" style="color:#141B1F">Toegewezen rapportages</div>
    <div class="text-body-2 mb-4" style="color:#47607C">Openstaande inspecties die aan jou zijn toegewezen.</div>
    ...
    <template v-else>
      <div v-if="assignedInspections.length === 0" class="text-body-2 text-medium-emphasis text-center py-6">
      ...
      <v-list v-else rounded="lg" bg-color="white" lines="two" class="inspection-list">
        ...
        >
          ...
          <template #append>
            <v-chip color="primary" size="small" variant="tonal" class="mr-1">Nieuw</v-chip>
...
export default {
  ...
  computed: {
    ...
    ...mapGetters(useInspectionStore, ['assignedInspections', 'selectedInspection']),
  },
  async mounted() {
